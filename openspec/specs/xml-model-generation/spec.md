...
Define how Rheingold XML model classes are generated from checked-in XSD schema files while preserving the existing serialization contract and handwritten behavior.
